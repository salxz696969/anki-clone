		...
		<>
			...
			{showConfirm && (
				<div className="fixed inset-0 flex items-center justify-center backdrop-blur-sm bg-black/20 z-50">
					<div className="bg-slate-800 shadow-2xl rounded-xl p-6 w-full max-w-md border-2 border-slate-50/30 mx-auto flex flex-col items-center">
						<p className="text-white text-lg mb-6">Are you sure you want to log out?</p>
